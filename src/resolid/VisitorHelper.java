...
/**
 * Implementaci�n del visitante que deja todas las funciones
 * vac�as. Permite no recargar las clases que necesitan implementar 
 * muy pocas funciones. Para los previsit que permiten cortar la exploracion,
 * esta implementaci�n no la corta.
