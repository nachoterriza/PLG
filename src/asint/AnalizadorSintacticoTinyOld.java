...
/** CUP v0.11b beta 20140220 generated parser.
  ...
  */
public class AnalizadorSintacticoTinyOld extends java_cup.runtime.lr_parser {

  /** Default constructor. */
  public AnalizadorSintacticoTinyOld() {super();}

  /** Constructor which sets the default scanner. */
  public AnalizadorSintacticoTinyOld(java_cup.runtime.Scanner s) {super(s);}

  /** Constructor which sets the default scanner. */
  public AnalizadorSintacticoTinyOld(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf) {super(s,sf);}
...
class CUP$AnalizadorSintacticoTiny$actions {
  private final AnalizadorSintacticoTinyOld parser;

  /** Constructor */
  CUP$AnalizadorSintacticoTiny$actions(AnalizadorSintacticoTinyOld parser) {
    this.parser = parser;
  }
